        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              Fine tuned tech support for your business
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              Comp is a fine tuned tech support company with self-taught experts
              in many fields of technology. We are here to help you with all
              your business needs.
            </p>

            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <Consultation />
              {/*Change github to phone svg */}
              <Link href="/">
                <a className="flex items-center space-x-2 text-gray-500 dark:text-gray-400">
                  <svg
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            Trusted by <span className="text-purple-500">500+</span> teams
            worldwide
          </div>
